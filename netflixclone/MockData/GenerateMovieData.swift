...
func generateMovies(_ count: Int) -> [Movie] {
    ...
    for _ in 0..<count {
        ...
        let cast = "Basil Rathbone, Hatty Jacques"
        let creators = "Miramax & HBO"
        let categories = ["Action", "Drama", "Thriller", "Box-Office"]
...
func generateTrailers(_ count: Int) -> [Trailer] {
    ...
    for _ in 0..<count {
        ...
        let thumbnail = URL(string: "https://picsum.photos/300/1\(randThumbnail)")!
        
        let trailer = Trailer(id: id, name: name, videoURL: exampleVideoURL1, thumbnailImageUrl: thumbnail)
...
func generateEpisodes(_ count: Int, forSeason season: Int) -> [Episode] {
    ...
    for num in 0..<count {
        ...
        let randThumbnail = Int.random(in: 10...99)
        let thumbnail = "https://picsum.photos/300/1\(randThumbnail)"
        ...
        let episode = Episode(id: id, name: name, season: season, episodeNumber: num + 1, thumbnailImageUrlString: thumbnail, description: desc, length: randLength, videoUrl: exampleVideoURL1)
