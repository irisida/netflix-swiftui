...
/// A trackable and scrollable view.
/// Read [this link](https://medium.com/@maxnatchanon/swiftui-how-to-get-content-offset-from-scrollview-5ce1f84603ec) for more.
///
...
struct TrackableScrollView<Content>: View where Content: View {
    ...
    ///   - showIndicators: A value that indicates whether the scroll view displays the
    ///   scrollable component of the content offset, in a way that’s suitable for the platform.
